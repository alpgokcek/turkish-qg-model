...
\begin{document}
	...
	\begin{abstractTR}
		% TO-DO
		Bu projedeki amacımız, Wikipedia gibi mevcut çevrimiçi kaynakları kullanarak bir Türkçe Soru Oluşturma Sistemi geliştirmektir. Soru Üretme Sistemleri, verilen metin girişinden çeşitli mantıksal sorular üretebilir. QG Sistemleri, sohbet robotları, otomatik derecelendirme sistemleri vb. Gibi birçok bilgisayar uygulamasında yaygındır. Bu tür bir sistemin geliştirilmesi, Türkçe'de herhangi bir çevrimiçi araç ve veri seti örneği bulunmadığından özellikle önemlidir. Bununla birlikte, QG araştırması İngilizce gibi diğer dillerde çoktan kayda değer bir seviyeye ulaştı ve bu görev için mevcut veri kümeleri var. Örneğin, Stanford Üniversitesi tarafından SQuAD, bu görev için İngilizce olarak kullanılan iyi bilinen veri kümelerinden biridir. \newline \par
