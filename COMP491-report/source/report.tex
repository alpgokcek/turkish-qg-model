...
\begin{document}
	...
	\begin{abstract}
		Over the last years, software we use has gained humanitarian characteristics. All of this features are invigorated by the Artificial Intelligence research which has showed significant improvements over the past decade. With the emergence of \gls{dl}, other sub-fields of AI such as \gls{nlp} made leaps in short amount of time as well. Today, results of the studies of these fields are ubiquitous. \newline \par
		
		Development of such applications require extensively large datasets for the training of \gls{dl} models. Furthermore, capability and the reliability of these applications are highly dependent on the data they have been trained on. \newline \par
		
		Labeled data in Turkish language is scarce, hence, development of AI-based applications in Turkish is bottle necked by the absence of data and requires significantly more effort comparing to other languages. \newline \par
		
		In this project we present the initial steps toward developing a \gls{qg} Model based on \gls{dl}. This paper includes the hard-coded training dataset generation for the \gls{dl} model to be developed in later stages.
